...
**Current step:** Step 6.6 — Designer: Malfini mode
**Last approved step:** Step 6.5 — Shop UI (unified products page, MalfiniProductCard, MalfiniProductDetails, Malfini product detail route, pricing fix)
**Next step:** Step 6.6 — Designer (branch: `phase-6/malfini-integration`)
