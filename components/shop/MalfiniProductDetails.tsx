  ...
  return (
    <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
      ...
      <div className="flex flex-col">
        ...
        {/* PDF documents */}
        {(product.sizeChartPdf || product.productCardPdf) && (
          <div className="mt-6 flex flex-wrap gap-3">
            {product.sizeChartPdf && (
              <a
                href={product.sizeChartPdf}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-sm border border-border-medium px-4 py-2 text-sm font-medium text-charcoal transition-colors hover:border-charcoal"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#dc2626" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            {product.productCardPdf && (
              <a
                href={product.productCardPdf}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-sm border border-border-medium px-4 py-2 text-sm font-medium text-charcoal transition-colors hover:border-charcoal"
              >
