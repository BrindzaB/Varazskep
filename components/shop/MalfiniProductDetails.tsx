...
function sortNomenclatures(noms: MalfiniNomenclature[]): MalfiniNomenclature[] {
                  ...
                  <button
                    ...
                    className={`rounded-sm border px-4 py-2 text-sm font-medium transition-colors disabled:opacity-40 ${
                      isSelected
                        ...
                        : "border-border-medium text-charcoal hover:border-charcoal disabled:cursor-not-allowed"
                    }`}
                  >
                    {nom.sizeName}
                  </button>
